...
export const DEFAULT_POSITIONS: ActivePosition[] = [
  {
    ...
    entryPrice: 0.35880,
    markPrice: 0.36322,
    unrealizedPnl: 0.1546,
    unrealizedPnlPct: 61.6,
    liquidationPrice: 0.3516,
    tp1: 0.3624,
    tp2: 0.3667,
    tp3: 0.3713,
    stopLoss: 0.3545,
  },
  {
    ...
    entryPrice: 0.01283,
    markPrice: 0.01292,
    unrealizedPnl: 0.0916,
    unrealizedPnlPct: 36.8,
    liquidationPrice: 0.01257,
    tp1: 0.01296,
    tp2: 0.01311,
    tp3: 0.01328,
    stopLoss: 0.01268,
  },
  {
    ...
    entryPrice: 0.04486,
    markPrice: 0.04510,
    unrealizedPnl: 0.0578,
    unrealizedPnlPct: 13.4,
    liquidationPrice: 0.04396,
    tp1: 0.04531,
    tp2: 0.04585,
    tp3: 0.04643,
    stopLoss: 0.04432,
  },
  {
    ...
    entryPrice: 0.00966,
    markPrice: 0.00969,
    unrealizedPnl: 0.0315,
    unrealizedPnlPct: 14.6,
    liquidationPrice: 0.00947,
    tp1: 0.00976,
    tp2: 0.00987,
    tp3: 0.01000,
    stopLoss: 0.00954,
  },
  {
    ...
    entryPrice: 5.4760,
    markPrice: 5.4868,
    unrealizedPnl: 0.0291,
    unrealizedPnlPct: 9.8,
    liquidationPrice: 5.3660,
    tp1: 5.5308,
    tp2: 5.5965,
    tp3: 5.6677,
    stopLoss: 5.4103,
  ...
  },
  {
    ...
    entryPrice: 0.35500,
    markPrice: 0.35550,
    unrealizedPnl: 0.0155,
    unrealizedPnlPct: 7.0,
    liquidationPrice: 0.3479,
    tp1: 0.3585,
    tp2: 0.3628,
    tp3: 0.3674,
    stopLoss: 0.3507,
  },
  {
    ...
    entryPrice: 0.76450,
    markPrice: 0.76510,
    unrealizedPnl: 0.0084,
    unrealizedPnlPct: 3.9,
    liquidationPrice: 0.7492,
    tp1: 0.7721,
    tp2: 0.7813,
    tp3: 0.7913,
    stopLoss: 0.7553,
  },
  {
    ...
    entryPrice: 0.52360,
    markPrice: 0.52266,
    unrealizedPnl: -0.0227,
    unrealizedPnlPct: -9.0,
    liquidationPrice: 0.5131,
    tp1: 0.5288,
    tp2: 0.5351,
    tp3: 0.5419,
    stopLoss: 0.5173,
  },
  {
    ...
    entryPrice: 2512.15,
    markPrice: 2508.37,
    unrealizedPnl: -0.0302,
    unrealizedPnlPct: -7.5,
    liquidationPrice: 2461.90,
    tp1: 2537.27,
    tp2: 2567.42,
    tp3: 2600.08,
    stopLoss: 2482.00,
