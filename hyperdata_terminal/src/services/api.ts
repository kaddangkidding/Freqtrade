...
export const DEFAULT_POSITIONS: ActivePosition[] = [
  {
    ...
    entryPrice: 0.11652,
    markPrice: 0.11559,
    unrealizedPnl: 0.2301,
    unrealizedPnlPct: 39.8,
    liquidationPrice: 0.11885,
    tp1: 0.11535,
    tp2: 0.11396,
    tp3: 0.11244,
    stopLoss: 0.11792,
  },
  {
    ...
    entryPrice: 0.00463,
    markPrice: 0.00466,
    unrealizedPnl: 0.1054,
    unrealizedPnlPct: 31.6,
    liquidationPrice: 0.00454,
    tp1: 0.00468,
    tp2: 0.00473,
    tp3: 0.00479,
    stopLoss: 0.00457,
  },
  {
    ...
    entryPrice: 0.21900,
    markPrice: 0.21891,
    unrealizedPnl: -0.0062,
    unrealizedPnlPct: -2.0,
    liquidationPrice: 0.21462,
    tp1: 0.22119,
    tp2: 0.22382,
    tp3: 0.22666,
    stopLoss: 0.21637,
  },
  {
    ...
    entryPrice: 0.08906,
    markPrice: 0.08896,
    unrealizedPnl: -0.0185,
    unrealizedPnlPct: -5.6,
    liquidationPrice: 0.08728,
    tp1: 0.08995,
    tp2: 0.09102,
    tp3: 0.09218,
    stopLoss: 0.08799,
  },
  {
    ...
    entryPrice: 0.15600,
    markPrice: 0.15493,
    unrealizedPnl: -0.1535,
    unrealizedPnlPct: -34.4,
    liquidationPrice: 0.15288,
    tp1: 0.15756,
    tp2: 0.15943,
    tp3: 0.16146,
    stopLoss: 0.15413,
  },
  {
    ...
    entryPrice: 0.81080,
    markPrice: 0.80331,
    unrealizedPnl: -0.2189,
    unrealizedPnlPct: -46.2,
    liquidationPrice: 0.79458,
    tp1: 0.81891,
    tp2: 0.82864,
    tp3: 0.83918,
    stopLoss: 0.80107,
  },
  {
    ...
    entryPrice: 0.00112,
    markPrice: 0.00111,
    unrealizedPnl: -0.2757,
    unrealizedPnlPct: -41.8,
    liquidationPrice: 0.00110,
    tp1: 0.00113,
    tp2: 0.00114,
    tp3: 0.00116,
    stopLoss: 0.00110,
  },
  {
    ...
    entryPrice: 134.86,
    markPrice: 133.28,
    unrealizedPnl: -0.3160,
    unrealizedPnlPct: -58.6,
    liquidationPrice: 132.16,
    tp1: 136.21,
    tp2: 137.83,
    tp3: 139.58,
    stopLoss: 133.24,
