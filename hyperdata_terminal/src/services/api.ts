...
export const DEFAULT_POSITIONS: ActivePosition[] = [
  {
    ...
    entryPrice: 0.22690,
    markPrice: 0.22580,
    unrealizedPnl: 0.0517,
    unrealizedPnlPct: 24.2,
    liquidationPrice: 0.23144,
    tp1: 0.22282,
    tp2: 0.22010,
    tp3: 0.21669,
    stopLoss: 0.22894,
  },
  {
    ...
    unrealizedPnlPct: 21.9,
    liquidationPrice: 733.40,
    tp1: 706.08,
    tp2: 697.45,
    tp3: 686.66,
    stopLoss: 725.49,
  },
  {
    ...
    entryPrice: 1.5170,
    markPrice: 1.5137,
    unrealizedPnl: 0.0245,
    unrealizedPnlPct: 10.8,
    liquidationPrice: 1.5473,
    tp1: 1.4897,
    tp2: 1.4715,
    tp3: 1.4487,
    stopLoss: 1.5307,
  },
  {
    ...
    entryPrice: 0.8222,
    markPrice: 0.8237,
    unrealizedPnl: -0.0190,
    unrealizedPnlPct: -9.0,
    liquidationPrice: 0.8386,
    tp1: 0.8074,
    tp2: 0.7975,
    tp3: 0.7852,
    stopLoss: 0.8296,
  },
  {
    ...
    entryPrice: 2500.99,
    markPrice: 2507.76,
    unrealizedPnl: -0.0542,
    unrealizedPnlPct: -13.5,
    liquidationPrice: 2551.0,
    tp1: 2455.97,
    tp2: 2425.96,
    tp3: 2388.45,
    stopLoss: 2523.50,
  },
  {
    ...
    entryPrice: 80537.30,
    markPrice: 80689.80,
    unrealizedPnl: -0.1525,
    unrealizedPnlPct: -9.5,
    liquidationPrice: 82148.0,
    tp1: 79087.6,
    tp2: 78121.2,
    tp3: 76913.1,
    stopLoss: 81262.1,
  },
  {
    ...
    entryPrice: 11.719,
    markPrice: 11.794,
    unrealizedPnl: -0.1313,
    unrealizedPnlPct: -32.0,
    liquidationPrice: 11.953,
    tp1: 11.508,
    tp2: 11.367,
    tp3: 11.192,
    stopLoss: 11.824,
